    ...
    <AlertDialogPortal>
      ...
      <AlertDialogPrimitive.Content
        ...
        className={cn(
          ...
          "fixed inset-0 z-50 grid !w-screen !h-[100dvh] !max-w-none !max-h-none gap-4 p-4 border-0 rounded-none shadow-lg duration-200 overflow-y-auto",
          "sm:top-[50%] sm:left-[50%] sm:right-auto sm:bottom-auto sm:h-auto sm:w-full sm:max-w-[calc(100%-2rem)] sm:translate-x-[-50%] sm:translate-y-[-50%]",
          "sm:max-w-lg sm:rounded-lg sm:border sm:p-6",
          className
        )}
        {...props}
      />
